...
To get started, you need to create an account on [Rendless](https://dev.rendless.com). Once you have created an account, you can create a template on the page [Templates](https://dev.rendless.com/templates) by clicking on the "Create template" button.
